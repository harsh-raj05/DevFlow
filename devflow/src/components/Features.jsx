      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-3">
          ...
          <motion.article
            ...
            className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-white/10 bg-[#0d0f13] p-7 transition duration-300 hover:border-lime-300/30 sm:p-8"
          >
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] text-lime-300">
                  <GitBranch size={18} />
                </div>
              </div>
